...
import { SubTitle } from '../../components/ui/Subtitlte';
        ...
        <CustomView margin>
            ...
            >
                <SectionList
                    ...
                    renderSectionHeader={({ section }) => <Text style={{ backgroundColor: colors.cardBackground, color: colors.text, fontSize: 25 }}>{section.title}</Text>}
